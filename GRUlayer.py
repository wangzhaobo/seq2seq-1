...
class GRUlayer:
    ...
    def __init__(self, inputSize, hiddenSize, name = "GRU Layer"):
    ...
    def getParameters(self):
        return self.E.get_value(), self.U.get_value(), self.W.get_value(), self.b.get_value()

    def loadParameters(self, params):
        self.E.set_value(params[0])
        self.U.set_value(params[1])
        self.W.set_value(params[2])
        self.b.set_value(params[3])
